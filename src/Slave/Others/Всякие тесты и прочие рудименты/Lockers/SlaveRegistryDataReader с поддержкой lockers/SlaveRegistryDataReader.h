			...
			public CRegistryDataWriter
{
	...
	protected:
		...
		// Читает из реестра данные для CInputLocker
		void DoReadInputLockerData(CInputLocker* pInputLocker, PHKEY phkKey);
		...
		void DoReadKeyboardLockerData(CKeyboardLocker* pLocker, PHKEY phkKey);
	...
	public:
		...
		// Читает из реестра данные для InputLocker'а
		virtual void ReadInputLockerData(CInputLocker* pInputLocker);
		...
		virtual void ReadKeyboardLockerData(CKeyboardLocker* pLocker);
